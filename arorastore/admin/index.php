...
$help  = '<p>' . __( 'Welcome to your  Dashboard!' ) . '</p>';
$help .= '<p>' . __( 'The Dashboard is the first place you will come to every time you log into your site. It is where you will find all your  tools. If you need help, just click the &#8220;Help&#8221; tab above the screen title.' ) . '</p>';
...
$help .= '<p>' . sprintf(
	/* translators: %s:  Planet URL. */
	__( '<strong> Events and News</strong> &mdash; Upcoming events near you as well as the latest news from the official  project and the <a href="%s"> Planet</a>.' ),
	__( 'https://planet..org/' )
) . '</p>';
...
$screen->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://.org/support/article/dashboard-screen/">Documentation on Dashboard</a>' ) . '</p>' .
