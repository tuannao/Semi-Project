...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://.org/support/article/users-your-profile-screen/">Documentation on User Profiles</a>' ) . '</p>' .
				...
				<table class="form-table" role="presentation">
					...
					<tr class="user-comment-shortcuts-wrap">
						...
						<td>
							...
							<?php _e( '<a href="https://.org/support/article/keyboard-shortcuts/" target="_blank">More information</a>' ); ?>
						</td>
					</tr>
					<?php endif; ?>
							...
							<?php elseif ( ! wp_is_application_passwords_supported() ) : ?>
								...
								<p>
									...
									printf(
										...
										__( 'https://.org/support/article/editing-wp-config-php/#wp_environment_type' )
									);
									?>
								</p>
							<?php endif; ?>
