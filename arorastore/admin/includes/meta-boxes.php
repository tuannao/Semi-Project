...
<p>
	...
	printf(
		...
		__( 'https://.org/support/article/excerpt/' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://.org/support/article/introduction-to-blogging/#comments' )
	);
	?>
</p>
	<?php
...
<p>
	...
	printf(
		...
		__( 'https://.org/support/article/custom-fields/' )
	);
	?>
</p>
	<?php
...
<p class="meta-options">
	...
	<label for="ping_status" class="selectit"><input name="ping_status" type="checkbox" id="ping_status" value="open" <?php checked( $post->ping_status, 'open' ); ?> />
		...
		printf(
			...
			__( 'https://.org/support/article/introduction-to-blogging/#managing-comments' )
		);
		?>
	</label>
	<?php
	 ...
	 * @param WP_Post $post WP_Post object for the current post.
	 */
	do_action( 'post_comment_status_meta_box-options', $post ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	?>
</p>
	<?php
}
