...
class WP_Plugins_List_Table extends WP_List_Table {
	...
	public function single_row( $item ) {
		...
		foreach ( $columns as $column_name => $column_display_name ) {
			...
			switch ( $column_name ) {
				...
				case 'description':
					 ...
					 *     @type string   $RequiresWP       The version of  which the plugin requires.
		...
		if ( ! $compatible_php || ! $compatible_wp ) {
			...
			if ( ! $compatible_php && ! $compatible_wp ) {
				_e( 'This plugin does not work with your versions of  and PHP.' );
				...
				_e( 'This plugin does not work with your version of .' );
