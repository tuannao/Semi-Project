...
/**
 * Retrieves list of  theme features (aka theme tags).
 *
 * @since 3.1.0
 ...
 *         {@link https://developer..org/reference/functions/themes_api/ function reference article}
...
function themes_api( $action, $args = array() ) {
	...
	/**
	 * Filters arguments used to query for installer pages from the .org Themes API.
	 *
	...
	/**
	 * Filters whether to override the .org Themes API.
	 *
	...
	if ( ! $res ) {
		$url = 'http://api..org/themes/info/1.2/';
		$url = add_query_arg(
			array(
				'action'  => $action,
				'request' => $args,
	...
	/**
	 * Filters the returned .org Themes API response.
	 *
	 * @since 2.8.0
	 *
	 * @param array|stdClass|WP_Error $res    .org Themes API response.
	 * @param string                  $action Requested action. Likely values are 'theme_information',
	 *                                        'feature_list', or 'query_themes'.
	 * @param stdClass                $args   Arguments used to query for installer pages from the .org Themes API.
	 */
