...
function wp_iframe( $content_func, ...$args ) {
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_styles-media-upload-popup' );  // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_print_scripts-media-upload-popup' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.9.0
	 */
	do_action( 'admin_head-media-upload-popup' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
...
function media_upload_form( $errors = null ) {
	...
	*/
	 ...
	 * @since 2.6.0
	 */
	do_action( 'pre-html-upload-ui' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	 ...
	 * @since 2.6.0
	 */
	do_action( 'post-html-upload-ui' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
...
function wp_read_video_metadata( $file ) {
	...
	$id3->options_audiovideo_quicktime_ReturnAtomData = true; // phpcs:ignore .NamingConventions.ValidVariableName
