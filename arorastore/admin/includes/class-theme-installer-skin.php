...
class Theme_Installer_Skin extends WP_Upgrader_Skin {
	...
	public function after() {
		 ...
		 * @param object   $api             Object containing .org API theme data.
	...
	private function do_overwrite() {
		...
		if ( ! is_wp_version_compatible( $requires_wp ) ) {
			$error = sprintf(
				/* translators: 1: Current  version, 2: Version required by the uploaded theme. */
				__( 'Your  version is %1$s, however the uploaded theme requires %2$s.' ),
