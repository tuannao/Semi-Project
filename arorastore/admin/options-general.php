...
if ( ! is_multisite() ) {
	$options_help .= '<p>' . __( 'The  URL and the site URL can be the same (example.com) or different; for example, having the  core files (example.com/) in a subdirectory instead of the root directory.' ) . '</p>' .
...
get_current_screen()->set_help_sidebar(
	...
	'<p>' . __( '<a href="https://.org/support/article/settings-general-screen/">Documentation on General Settings</a>' ) . '</p>' .
...
<p class="description" id="home-description">
		...
		printf(
			...
			__( 'Enter the address here if you <a href="%s">want your site home page to be different from your  installation directory</a>.' ),
			__( 'https://.org/support/article/giving--its-own-directory/' )
		);
		?>
</p>
<?php endif; ?>
...
foreach ( $time_formats as $format ) {
	...
	echo "\t<p class='date-time-doc'>" . __( '<a href="https://.org/support/article/formatting-date-and-time/">Documentation on date and time formatting</a>.' ) . "</p>\n";
?>
	</fieldset>
</td>
</tr>
