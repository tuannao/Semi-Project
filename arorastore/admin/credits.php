	...
	<div class="about__header">
		...
		<div class="about__header-text">
			...
			printf(
				...
				__( ' %s was created by a worldwide team of passionate individuals' ),
				$display_version
			);
			?>
		</div>
	...
	<div class="about__section has-1-column">
		<div class="column aligncenter">
			...
			<p>
				<?php
				printf(
					/* translators: 1: https://.org/about/ */
					__( ' is created by a <a href="%1$s">worldwide team</a> of passionate individuals.' ),
					__( 'https://.org/about/' )
				);
				?>
				<br />
				<a href="https://make..org/"><?php _e( 'Get involved in .' ); ?></a>
			</p>
