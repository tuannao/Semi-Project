...
/** _Network class */
require_once ABSPATH . INC . '/class-network.php';

/** _Site class */
require_once ABSPATH . INC . '/class-site.php';

/** Multisite loader */
require_once ABSPATH . INC . '/ms-load.php';

/** Default Multisite constants */
require_once ABSPATH . INC . '/ms-default-constants.php';

if ( defined( 'SUNRISE' ) ) {
	include_once _CONTENT_DIR . '/sunrise.php';
}
...
if ( ! isset( $current_site ) || ! isset( $current_blog ) ) {
	...
	_load_core_site_options( $site_id );
}
...
$__switched_stack = array();
$switched           = false;

// Need to init cache again after blog_id is set.
_start_object_cache();

if ( ! $current_site instanceof _Network ) {
	$current_site = new _Network( $current_site );
}

if ( ! $current_blog instanceof _Site ) {
	$current_blog = new _Site( $current_blog );
}
