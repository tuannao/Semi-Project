...
function fetch_feed( $url ) {
	...
	require_once ABSPATH . WPINC . '/class-feed-cache-transient.php';
	require_once ABSPATH . WPINC . '/class-simplepie-file.php';
	require_once ABSPATH . WPINC . '/class-simplepie-sanitize-kses.php';
	...
	if ( method_exists( 'SimplePie_Cache', 'register' ) ) {
		...
		require_once ABSPATH . WPINC . '/class-feed-cache.php';
	...
	/** This filter is documented in includes/class-feed-cache-transient.php */
