...
final class WP_Customize_Widgets {
	...
	public function __construct( $manager ) {
		...
		// See https://github.com/xwp/customize-snapshots/blob/962586659688a5b1fd9ae93618b7ce2d4e7a421c/php/class-customize-snapshot-manager.php#L420-L449
	...
	public function customize_controls_init() {
		...
		do_action( 'load-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores

		/** This action is documented in admin/includes/ajax-actions.php */
		do_action( 'widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	 ...
	 *
	 * When in preview, hook to {@see 'customize_register'} for settings after  is loaded
	...
	public function print_styles() {
		...
		do_action( 'admin_print_styles-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	...
	public function print_scripts() {
		/** This action is documented in admin/admin-header.php */
		do_action( 'admin_print_scripts-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	...
	public function enqueue_scripts() {
		...
		/*
		 * TODO: Update 'customize-widgets' to not rely so much on things in
	...
	public function print_footer_scripts() {
		...
		do_action( 'admin_print_footer_scripts-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores

		/** This action is documented in admin/admin-footer.php */
		do_action( 'admin_print_footer_scripts' );

		/** This action is documented in admin/admin-footer.php */
		do_action( 'admin_footer-widgets.php' ); // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
	}
