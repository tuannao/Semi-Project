...
/**
 * Retrieves all of the  supported comment statuses.
 *
 ...
 * @since 2.9.0
 *
 * @link https://developer..org/reference/functions/add_comment_meta/
 *
 ...
 * @since 2.9.0
 *
 * @link https://developer..org/reference/functions/delete_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 * @param string $meta_key   Metadata name.
 ...
 * @since 2.9.0
 *
 * @link https://developer..org/reference/functions/get_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 ...
 * @since 2.9.0
 *
 * @link https://developer..org/reference/functions/update_comment_meta/
 *
 * @param int    $comment_id Comment ID.
 ...
 * and whether comment is approved by . Also has {@see 'preprocess_comment'}
 * filter for processing the comment data before the function handles it.
 *
 * We use `REMOTE_ADDR` here directly. If you are behind a proxy, you should ensure
 * that it is properly set, such as in wp-config.php, for your environment.
 *
 * See {@link https://core.trac..org/ticket/9235}
 *
 * @since 1.5.0
...
function pingback( $content, $post_id ) {
	...
	foreach ( (array) $post_links as $pagelinkedto ) {
		...
		if ( $pingback_server_url ) {
			 ...
			 */
			$client->useragent = apply_filters( 'pingback_useragent', $client->useragent . ' -- /' . get_bloginfo( 'version' ), $client->useragent, $pingback_server_url, $pagelinkedto, $pagelinkedfrom );
...
function weblog_ping( $server = '', $path = '' ) {
	...
	$client->timeout    = 3;
	$client->useragent .= ' -- /' . get_bloginfo( 'version' );
...
function wp_register_comment_personal_data_exporter( $exporters ) {
	$exporters['-comments'] = array(
		'exporter_friendly_name' => __( ' Comments' ),
...
function wp_register_comment_personal_data_eraser( $erasers ) {
	$erasers['-comments'] = array(
		'eraser_friendly_name' => __( ' Comments' ),
...
function _wp_batch_update_comment_type() {
	...
	if ( $comment_ids ) {
		...
		$wpdb->query(
			...
			WHERE comment_type = ''
			AND comment_ID IN ({$comment_id_list})" // phpcs:ignore .DB.PreparedSQL.InterpolatedNotPrepared
		);
