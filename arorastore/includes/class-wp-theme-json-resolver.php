...
class WP_Theme_JSON_Resolver {
		...
		if ( is_array( $recent_posts ) && ( count( $recent_posts ) === 1 ) ) {
			...
			$cpt_post_id = wp_insert_post(
				array(
					...
					'post_type'    => $post_type_filter,
					'post_name'    => 'global-styles-' . urlencode( wp_get_theme()->get_stylesheet() ),
					'tax_input'    => array(
	 ...
	 *
	 * Unlike the getters
	 * {@link https://developer..org/reference/classes/wp_theme_json_resolver/get_core_data/ get_core_data},
	 * {@link https://developer..org/reference/classes/wp_theme_json_resolver/get_theme_data/ get_theme_data},
	 * and {@link https://developer..org/reference/classes/wp_theme_json_resolver/get_user_data/ get_user_data},
