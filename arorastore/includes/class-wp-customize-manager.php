...
final class WP_Customize_Manager {
	...
	public function __construct( $args = array() ) {
		...
		require_once ABSPATH . WPINC . '/class-customize-setting.php';
		require_once ABSPATH . WPINC . '/class-customize-panel.php';
		require_once ABSPATH . WPINC . '/class-customize-section.php';
		require_once ABSPATH . WPINC . '/class-customize-control.php';

		require_once ABSPATH . WPINC . '/customize/class-customize-color-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-media-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-upload-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-image-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-background-image-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-background-position-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-cropped-image-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-site-icon-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-header-image-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-theme-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-code-editor-control.php';
		require_once ABSPATH . WPINC . '/customize/class-widget-area-customize-control.php';
		require_once ABSPATH . WPINC . '/customize/class-widget-form-customize-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-item-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-location-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-name-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-locations-control.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-auto-add-control.php';

		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menus-panel.php';

		require_once ABSPATH . WPINC . '/customize/class-customize-themes-panel.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-themes-section.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-sidebar-section.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-section.php';

		require_once ABSPATH . WPINC . '/customize/class-customize-custom-css-setting.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-filter-setting.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-header-image-setting.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-background-image-setting.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-item-setting.php';
		require_once ABSPATH . WPINC . '/customize/class-customize-nav-menu-setting.php';
		...
		require_once ABSPATH . WPINC . '/customize/class-customize-selective-refresh.php';
		$this->selective_refresh = new WP_Customize_Selective_Refresh( $this );

		if ( in_array( 'widgets', $components, true ) ) {
			require_once ABSPATH . WPINC . '/class-customize-widgets.php';
			$this->widgets = new WP_Customize_Widgets( $this );
		}

		if ( in_array( 'nav_menus', $components, true ) ) {
			require_once ABSPATH . WPINC . '/class-customize-nav-menus.php';
	...
	public function setup_theme() {
		 ...
		 * For similar behavior elsewhere in , see rest_cookie_check_errors() which logs out
	...
	public function start_previewing_theme() {
		...
		if ( ! $this->is_theme_active() ) {
			...
			// @link: https://core.trac..org/ticket/20027
	...
	public function customize_preview_init() {
		 ...
		 * allowed then the auth cookies would not be sent and  would
	...
	public function validate_setting_values( $setting_values, $options = array() ) {
		...
		foreach ( $setting_values as $setting_id => $unsanitized_value ) {
			...
			if ( ! is_wp_error( $validity ) ) {
				/** This filter is documented in includes/class-customize-setting.php */
	 ...
	 * @since 4.9.0
	 *
	 * @link https://core.trac..org/ticket/40922
	 ...
	 * @link https://developer..org/themes/customize-api
	 *
		...
		if ( in_array( $id, $this->components, true ) ) {
			_doing_it_wrong(
				...
				sprintf(
					...
					sprintf(
						'<a href="%1$s">%2$s</a>',
						esc_url( 'https://developer..org/reference/hooks/customize_loaded_components/' ),
				...
				<div class="notification-message customize-changeset-locked-message">
					...
					<p class="action-buttons">
						...
						<# if ( data.allowOverride ) { #>
							<button class="button button-primary tab-last customize-notice-take-over-button"><?php _e( 'Take over' ); ?></button>
						<# } #>
					</p>
				</div>
			</li>
	...
	public function register_controls() {
		...
		$this->add_panel(
			new WP_Customize_Themes_Panel(
				...
				array(
					...
					'description' => (
					'<p>' . __( 'Looking for a theme? You can search or browse the .org theme directory, install and preview themes, then activate them right here.' ) . '</p>' .
		...
		$this->add_control(
			new WP_Customize_Site_Icon_Control(
				...
				array(
					'label'       => __( 'Site Icon' ),
					'description' => sprintf(
						'<p>' . __( 'Site Icons are what you see in browser tabs, bookmark bars, and within the  mobile apps. Upload one here!' ) . '</p>' .
		...
		if ( get_theme_support( 'custom-background', 'head-callback' ) === '_custom_background_cb' ) {
		...
		/*
		 * Static Front Page
		 * See also https://core.trac..org/ticket/19627 which introduces the static-front-page theme_support.
		...
		$section_description .= sprintf(
			...
			esc_url( __( 'https://codex..org/CSS' ) ),
	...
	public function handle_load_themes_request() {
		...
		if ( 'installed' === $theme_action ) {
			...
			// Load .org themes from the .org API and normalize data to match installed theme objects.
			...
			// Set up properties for themes available on .org.
			foreach ( $themes->themes as &$theme ) {
				...
				$theme->compatibleWP  = is_wp_version_compatible( $theme->requires ); // phpcs:ignore .NamingConventions.ValidVariableName
				$theme->compatiblePHP = is_php_version_compatible( $theme->requires_php ); // phpcs:ignore .NamingConventions.ValidVariableName
