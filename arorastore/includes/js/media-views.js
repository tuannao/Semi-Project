...
AttachmentsBrowser = View.extend(/** @lends wp.media.view.AttachmentsBrowser.prototype */{
	...
	createToolbar: function() {
		...
		if ( this.controller.isModeActive( 'grid' ) ) {
			toolbarOptions.className = 'media-toolbar filter';
		}
...
/**
 * Creates a dropzone on WP editor instances (elements with .editor-wrap)
...
EditorUploader = View.extend(/** @lends wp.media.view.EditorUploader.prototype */{
	...
	render: function() {
		...
		View.prototype.render.apply( this, arguments );
		$( '.editor-wrap' ).each( _.bind( this.attach, this ) );
		return this;
	},
	...
	drop: function( event ) {
		...
		$wrap = $( event.target ).parents( '.editor-wrap' );
...
UploaderWindow = wp.media.View.extend(/** @lends wp.media.view.UploaderWindow.prototype */{
	...
	hide: function() {
		...
		// https://core.trac..org/ticket/27341
		_.delay( function() {
