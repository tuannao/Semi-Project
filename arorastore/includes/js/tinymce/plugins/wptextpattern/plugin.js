 ...
 * The setting name is `textpattern` and the value is an object containing override arrays for each
 * patterns group. There are three groups: "space", "enter", and "inline". Example (PHP):
 *
 * add_filter( 'tiny_mce_before_init', 'my_mce_init_textpattern' );
 * function my_mce_init_textpattern( $init ) {
 *   $init['textpattern'] = _json_encode( array(
 *      'inline' => array(
...
( function( tinymce, setTimeout ) {
	...
	tinymce.PluginManager.add( 'textpattern', function( editor ) {
		...
		var settings = editor.settings.textpattern || {};
