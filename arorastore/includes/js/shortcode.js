...
(function(){
	.shortcode = {
		 ...
		 * generated by `.shortcode.regexp()`. `match` can also be set
...
(function(){
	.html = _.extend( .html || {}, {
		 ...
		 * Utilizes `.shortcode.attrs( content )`, which is a valid superset of
		...
		attrs: function( content ) {
			...
			result = .shortcode.attrs( content );
			attrs  = result.named;
		...
		string: function( options ) {
			...
			text += _.isObject( content ) ? .html.string( content ) : content;
