/**
 * @output includes/js/backbone.js
 */
...
(function ($) {
	 ...
	 *
	 * @since 3.5.0
	 * @since 3.6.0 Moved .media.Views to .Backbone.Subviews.
	 *
	 * @memberOf .Backbone
	 *
	 * @class
	 *
	 * @param {.Backbone.View} view  The main view.
	 * @param {Array|Object}     views The subviews for the main view.
	 */
	.Backbone.Subviews = function( view, views ) {
		this.view = view;
		this._views = _.isArray( views ) ? { '': views } : views || {};
	};

	.Backbone.Subviews.extend = Backbone.Model.extend;

	_.extend( .Backbone.Subviews.prototype, {
		/**
		 ...
		 *
		 * @return {.Backbone.Subviews} The current Subviews instance.
		 */
		set: function( selector, views, options ) {
			...
			_.each( views, function( subview ) {
				var constructor = subview.Views || .Backbone.Subviews,
	...
	.Backbone.View = Backbone.View.extend({
		 ...
		 *
		 * @since 3.5.0
		 * @since 3.6.0 Moved .media.View to .Backbone.View
		 *
		 * @constructs
		 ...
		 * @since 3.5.0
		 *
		 * @return {.Backbone.View} The current instance of the view.
		 */
		render: function() {
			var options;
