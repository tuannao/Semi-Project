...
// NAMESPACE OBJECT: ./node_modules/@/blocks/build-module/store/selectors.js
...
// NAMESPACE OBJECT: ./node_modules/@/blocks/build-module/store/actions.js
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/store/reducer.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/store/selectors.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/constants.js
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/registration.js
 ...
 *
 * @see https://developer..org/resource/dashicons/
 */
...
function unstable__bootstrapServerSideBlockDefinitions(definitions) {
  for (const blockName of Object.keys(definitions)) {
    ...
    if (serverSideBlockDefinitions[blockName]) {
      ...
      // @see https://github.com//gutenberg/pull/39894
...
function translateBlockSettingUsingI18nSchema(i18nSchema, settingValue, textdomain) {
  if ((0,external_lodash_namespaceObject.isString)(i18nSchema) && (0,external_lodash_namespaceObject.isString)(settingValue)) {
    // eslint-disable-next-line @/i18n-no-variables, @/i18n-text-domain
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/factory.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/utils.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/store/actions.js
/**
 * External dependencies
 */
...
const processBlockType = (blockType, _ref) => {
  ...
  if (!isValidIcon(settings.icon.src)) {
    error('The icon passed is invalid. ' + 'The icon should be a string, an element, a function, or an object following the specifications documented in https://developer..org/block-editor/developers/block-api/block-registration/#icon-optional');
    return;
  }
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/store/constants.js
const STORE_NAME = 'core/blocks';

;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/store/index.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/serialize-raw-block.js
/**
 * Internal dependencies
 */
 ...
 * following functions available in the `@/blocks` package:
 *
 * @see serializeBlock
 * @see serialize
 *
 ...
 *
 * @see `@/block-serialization-default-parser` package
 * @see `@/block-serialization-spec-parser` package
 *
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/serializer.js
...
function getBlockDefaultClassName(blockName) {
  // Generated HTML classes for blocks follow the `block-{name}` nomenclature.
  // Blocks provided by  drop the prefixes 'core/' or 'core-' (historically used in 'core-embed/').
  const className = 'block-' + blockName.replace(/\//, '-').replace(/^core-/, '');
...
function serializeAttributes(attributes) {
  ...
  //
  // See: https://developer..org/reference/functions/wp_kses_stripslashes/
  .replace(/\\"/g, '\\u0022');
}
/**
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/validation/logger.js
/**
 * @typedef LoggerItem
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/validation/index.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/convert-legacy-block.js
/**
...
function convertLegacyBlockNameAndAttributes(name, attributes) {
  ...
  if ('core/text' === name || 'core/cover-text' === name) {
    name = 'core/paragraph';
  } // Convert derivative blocks such as 'core/social-link-' to the
  // canonical form 'core/social-link'.


  if (name && name.indexOf('core/social-link-') === 0) {
    // Capture `social-link-` into `{"service":""}`
  ...
  // TODO: Remove this check when  5.9 is released.


  if (name === 'core/query-loop') {
    name = 'core/post-template';
  } // Convert Post Comment blocks in existing content to Comment blocks.
  // TODO: Remove these checks when  6.0 is released.
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/matchers.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/node.js
/**
 * Internal dependencies
 */
 ...
 * source `node`.
 *
 * @see https://github.com//gutenberg/pull/10439
 *
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/children.js
/**
 * External dependencies
 */
...
/**
 * Given block children, returns a serialize-capable  element.
 *
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/get-block-attributes.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/fix-custom-classname.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/apply-built-in-validation-fixes.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/apply-block-deprecated-versions.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/parser/index.js
/**
 *  dependencies
 */
...
function parseRawBlock(rawBlock, options) {
  ...
  const parsedInnerBlocks = normalizedBlock.innerBlocks.map(innerBlock => parseRawBlock(innerBlock, options)) // See https://github.com//gutenberg/pull/17164.
 ...
 *
 * @see
 * https://developer..org/block-editor/packages/packages-block-serialization-default-parser/
 *
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/get-raw-transforms.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/html-to-blocks.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/normalise-blocks.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/special-comment-converter.js
/**
 *  dependencies
 */
...
function createMore(customText, noTeaser, doc) {
  const node = doc.createElement('block');
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/list-reducer.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/blockquote-normaliser.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/figure-content-reducer.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/shortcode-converter.js
/**
 * External dependencies
 */
...
function segmentHTMLToShortcodeBlock(HTML) {
  ...
  if (match = (0,external_wp_shortcode_namespaceObject.next)(transformTag, HTML, lastIndex)) {
    ...
    //
    // See: https://github.com//gutenberg/pull/3610#discussion_r152546926
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/utils.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/index.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/comment-remover.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/is-inline-content.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/phrasing-content-reducer.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/head-remover.js
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/ms-list-converter.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/image-corrector.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/div-normaliser.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/markdown-converter.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/iframe-remover.js
/**
 * Removes iframes.
 *
 * @param {Node} node The node to check.
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/google-docs-uid-remover.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/html-formatting-remover.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/br-remover.js
/**
 * Internal dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/empty-paragraph-remover.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/raw-handling/paste-handler.js
/**
 * External dependencies
 */
...
function pasteHandler(_ref) {
  ...
  // See: https://core.trac..org/ticket/30130
  // See: https://github.com//gutenberg/pull/6983#pullrequestreview-125151075
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/categories.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/templates.js
/**
 * External dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/api/index.js
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/block-content-provider/index.js
...
;// CONCATENATED MODULE: ./node_modules/@/blocks/build-module/index.js
