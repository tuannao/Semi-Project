...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/nonce.js
/**
 * @param {string} nonce
...
function createNonceMiddleware(nonce) {
  ...
  const middleware = (options, next) => {
    const {
      headers = {}
    } = options; // If an 'X-Nonce' header (or any case-insensitive variation
    // thereof) was specified, no need to add a nonce header.

    for (const headerName in headers) {
      if (headerName.toLowerCase() === 'x-nonce' && headers[headerName] === middleware.nonce) {
        return next(options);
      }
    }
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/namespace-endpoint.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/root-url.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/preloading.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/fetch-all-middleware.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/http-v1.js
/**
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/user-locale.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/utils/response.js
/**
 *  dependencies
 */
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/middlewares/media-upload.js
/**
 *  dependencies
 */
...
const mediaUploadMiddleware = (options, next) => {
  ...
  return next({ ...options,
    ...
    const attachmentId = response.headers.get('x-upload-attachment-id');
...
;// CONCATENATED MODULE: ./node_modules/@/api-fetch/build-module/index.js
/**
 *  dependencies
 */
...
const DEFAULT_HEADERS = {
  ...
  //
  // See: https://core.trac..org/ticket/44534
