...
;// CONCATENATED MODULE: ./node_modules/@/server-side-render/build-module/server-side-render.js
...
;// CONCATENATED MODULE: ./node_modules/@/server-side-render/build-module/index.js
...
const ExportedServerSideRender = (0,external_wp_data_namespaceObject.withSelect)(select => {
  // FIXME: @/server-side-render should not depend on @/editor.
  // It is used by blocks that can be loaded into a *non-post* block editor.
  // eslint-disable-next-line @/data-no-store-string-literals
