 ...
 * <div class="block-columns has-3-columns"><!-- wp:column -->
 * <div class="block-column"><!-- wp:paragraph -->
 * <p>Left</p>
 * <!-- /wp:paragraph --></div>
 * <!-- /wp:column -->
 *
 ...
 * Parsing code:
 * ```js
 * import { parse } from '@/block-serialization-default-parser';
 *
 * parse( post ) === [
 *     {
 ...
 *             }
 *         ],
 *         innerHTML: '\n<div class="block-columns has-3-columns">\n\n\n\n</div>\n'
 *     }
 * ];
 * ```
