 ...
 */
function get_comment_author_IP( $comment_ID = 0 ) { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment = get_comment( $comment_ID );
	 ...
	 * @param WP_Comment $comment           The comment object.
	 */
	return apply_filters( 'get_comment_author_IP', $comment->comment_author_IP, $comment->comment_ID, $comment );  // phpcs:ignore .NamingConventions.ValidHookName.NotLowercase
}
 ...
 *                                   Default current comment.
 */
function comment_author_IP( $comment_ID = 0 ) { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
 ...
 */
function get_comment_ID() { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
	$comment    = get_comment();
	 ...
	 * @param WP_Comment $comment    The comment object.
	 */
	return apply_filters( 'get_comment_ID', $comment_ID, $comment );  // phpcs:ignore .NamingConventions.ValidHookName.NotLowercase
}
 ...
 * @since 0.71
 */
function comment_ID() { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
	echo get_comment_ID();
}
 ...
 *           comment. See https://core.trac..org/changeset/36512.
 *
 * @since 2.7.0
 *
 * @global WP_Comment $comment Global comment object.
