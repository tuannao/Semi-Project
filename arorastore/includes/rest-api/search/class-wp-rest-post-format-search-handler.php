<?php
/**
 * REST API: _REST_Post_Format_Search_Handler class
 *
 * @package 
 * @subpackage REST_API
 * @since 5.6.0
 ...
 */
class _REST_Post_Format_Search_Handler extends _REST_Search_Handler {
	...
	public function prepare_item( $id, array $fields ) {
		...
		if ( in_array( _REST_Search_Controller::PROP_ID, $fields, true ) ) {
			$data[ _REST_Search_Controller::PROP_ID ] = $id;
		}

		if ( in_array( _REST_Search_Controller::PROP_TITLE, $fields, true ) ) {
			$data[ _REST_Search_Controller::PROP_TITLE ] = get_post_format_string( $id );
		}

		if ( in_array( _REST_Search_Controller::PROP_URL, $fields, true ) ) {
			$data[ _REST_Search_Controller::PROP_URL ] = get_post_format_link( $id );
		}
