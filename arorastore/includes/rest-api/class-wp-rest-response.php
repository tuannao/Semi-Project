 ...
 * @see _HTTP_Response
 */
class _REST_Response extends _HTTP_Response {
	...
	public function remove_link( $rel, $href = null ) {
		...
		if ( $href ) {
			$this->links[ $rel ] = _list_filter( $this->links[ $rel ], array( 'href' => $href ), 'NOT' );
		} else {
			$this->links[ $rel ] = array();
		}
	...
	/**
	 * Retrieves a _Error object from the response.
	 *
	 * @since 4.4.0
	 *
	 * @return _Error|null _Error or null on not an errored response.
	 */
