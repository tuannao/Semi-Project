<?php
/**
 * Reusable blocks REST API: _REST_Blocks_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 5.0.0
 ...
 * edit and delete reusable blocks. Blocks are stored as posts with the _block
 * post type.
 *
 * @since 5.0.0
 *
 ...
 */
class _REST_Blocks_Controller extends _REST_Posts_Controller {
	 ...
	 * @since 5.0.0
	 *
	 * @param _Post $post Post object that backs the block.
