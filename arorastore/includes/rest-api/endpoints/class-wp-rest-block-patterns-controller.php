<?php
/**
 * REST API: _REST_Block_Patterns_Controller class
 *
 * @package    
 * @subpackage REST_API
 * @since      6.0.0
 ...
 */
class _REST_Block_Patterns_Controller extends _REST_Controller {
	...
	public function get_items( $request ) {
		...
		$response = array();
		$patterns = _Block_Patterns_Registry::get_instance()->get_all_registered();
