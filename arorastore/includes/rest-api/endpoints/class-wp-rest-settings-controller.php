<?php
/**
 * REST API: _REST_Settings_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class _REST_Settings_Controller extends _REST_Controller {
	 ...
	 *
	 * @param _REST_Request $request Full details about the request.
	 * @return array|_Error Array on success, or _Error object on failure.
	 */
	 ...
	 *
	 * @param _REST_Request $request Full details about the request.
	 * @return array|_Error Array on success, or error object on failure.
	 */
	public function update_item( $request ) {
		...
		foreach ( $options as $name => $args ) {
			...
			if ( is_null( $request[ $name ] ) ) {
				 ...
				 * database.
				 */
				if ( is__error( rest_validate_value_from_schema( get_option( $args['option_name'], false ), $args['schema'] ) ) ) {
					return new _Error(
