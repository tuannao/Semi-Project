<?php
/**
 * REST API: _REST_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 4.7.0
 ...
 * @since 4.7.0
 */
abstract class _REST_Controller {
	...
	public function register_routes() {
		_doing_it_wrong(
			'_REST_Controller::register_routes',
	 ...
	 * @since 4.7.0
	 *
	 * @param object          $object  Data model like _Term or _Post.
	 * @param _REST_Request $request Full details about the request.
	 * @return true|_Error True on success, _Error object if a field cannot be updated.
	 */
	 ...
	 * @since 4.7.0
	 *
	 * @global array $_rest_additional_fields Holds registered fields, organized by object type.
	 *
	...
	protected function get_additional_fields( $object_type = null ) {
		...
		if ( ! $_rest_additional_fields || ! isset( $_rest_additional_fields[ $object_type ] ) ) {
			return array();
		}

		return $_rest_additional_fields[ $object_type ];
	}
	...
	public function get_fields_for_response( $request ) {
		...
		$requested_fields = _parse_list( $request['_fields'] );
	 ...
	 *                       on `EDITABLE` requests. Default _REST_Server::CREATABLE.
	 * @return array Endpoint arguments.
	 */
	public function get_endpoint_args_for_item_schema( $method = _REST_Server::CREATABLE ) {
	 ...
	 *
	 * @todo Remove this in favour of https://core.trac..org/ticket/34659
	 *
