<?php
/**
 * Block Renderer REST API: _REST_Block_Renderer_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 5.0.0
 ...
 */
class _REST_Block_Renderer_Controller extends _REST_Controller {
	...
	public function register_routes() {
		register_rest_route(
			...
			array(
				...
				array(
					'methods'             => array( _REST_Server::READABLE, _REST_Server::CREATABLE ),
					...
					'args'                => array(
						...
						'attributes' => array(
							...
							'validate_callback' => static function ( $value, $request ) {
								$block = _Block_Type_Registry::get_instance()->get_registered( $request['name'] );
