<?php
/**
 * REST API: _REST_Taxonomies_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class _REST_Taxonomies_Controller extends _REST_Controller {
	 ...
	 *
	 * @param _Taxonomy     $item    Taxonomy data.
	 * @param _REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		 ...
		 * @param _Taxonomy      $item     The original taxonomy object.
