<?php
/**
 * REST API: _REST_Edit_Site_Export_Controller class
 *
 * @package    
 * @subpackage REST_API
 */
 ...
 */
class _REST_Edit_Site_Export_Controller extends _REST_Controller {
	 ...
	 * @since 5.9.0
	 *
	 * @return _Error|true True if the request has access, or _Error object.
	 */
	...
	public function export() {
		...
		$filename = _generate_block_templates_export_file();

		if ( is__error( $filename ) ) {
