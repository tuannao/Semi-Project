<?php
/**
 * REST API: _REST_Menu_Locations_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 5.9.0
 ...
 */
class _REST_Menu_Locations_Controller extends _REST_Controller {
	 ...
	 * @return _Error|bool True if the request has read access, _Error object otherwise.
	 */
	 ...
	 *
	 * @param _REST_Request $request Full details about the request.
	 * @return _Error|bool True if the request has read access for the item, _Error object otherwise.
	 */
	...
	public function get_item( $request ) {
		...
		if ( ! array_key_exists( $request['location'], $registered_menus ) ) {
			return new _Error( 'rest_menu_location_invalid', __( 'Invalid menu location.' ), array( 'status' => 404 ) );
		}
	 ...
	 * @param _REST_Request $request Full details about the request.
	 * @return _REST_Response Menu location data.
	 */
