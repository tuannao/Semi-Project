<?php
/**
 * REST API: _REST_Post_Types_Controller class
 *
 * @package 
 * @subpackage REST_API
 * @since 4.7.0
 ...
 */
class _REST_Post_Types_Controller extends _REST_Controller {
	 ...
	 *
	 * @param _Post_Type    $item    Post type object.
	 * @param _REST_Request $request Full details about the request.
	...
	public function prepare_item_for_response( $item, $request ) {
		...
		$post_type  = $item;
		$taxonomies = _list_filter( get_object_taxonomies( $post_type->name, 'objects' ), array( 'show_in_rest' => true ) );
		$taxonomies = _list_pluck( $taxonomies, 'name' );
		 ...
		 * @param _Post_Type     $post_type The original post type object.
