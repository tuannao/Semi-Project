	...
	protected function render_content() {
		...
		switch ( $this->type ) {
			...
			case 'dropdown-pages':
				...
				// @todo Eventually this should be removed in favor of the pages being injected into the underlying get_pages() call. See <https://github.com/xwp/customize-posts/pull/250>.
 ...
 */
require_once ABSPATH . WPINC . '/customize/class-customize-date-time-control.php';

/**
 * WP_Sidebar_Block_Editor_Control class.
 */
require_once ABSPATH . WPINC . '/customize/class-sidebar-block-editor-control.php';
