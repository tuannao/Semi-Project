<?php
/**
 * Sitemaps: _Sitemaps_Provider class
 *
...
/**
 * Class _Sitemaps_Provider.
 *
 * @since 5.5.0
 */
abstract class _Sitemaps_Provider {
	/**
	 * Provider name.
	 *
	...
	public function get_sitemap_entries() {
		...
		foreach ( $sitemap_types as $type ) {
			for ( $page = 1; $page <= $type['pages']; $page ++ ) {
				 ...
				 */
				$sitemap_entry = apply_filters( '_sitemaps_index_entry', $sitemap_entry, $this->object_type, $type['name'], $page );
