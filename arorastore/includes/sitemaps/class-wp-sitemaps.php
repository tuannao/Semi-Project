...
class _Sitemaps {
	 ...
	 * @since 5.5.0
	 *
	 * @var _Sitemaps_Renderer
	 */
	public $renderer;

	/**
	 * _Sitemaps constructor.
	 *
	 * @since 5.5.0
	 */
	public function __construct() {
		$this->registry = new _Sitemaps_Registry();
		$this->renderer = new _Sitemaps_Renderer();
		$this->index    = new _Sitemaps_Index( $this->registry );
	}
	...
	public function sitemaps_enabled() {
		 ...
		 *
		 * @see _Sitemaps::register_rewrites()
		 *
		 * @since 5.5.0
		 *
		 ...
		 */
		return (bool) apply_filters( '_sitemaps_enabled', $is_enabled );
	}
	...
	public function register_sitemaps() {
		$providers = array(
			'posts'      => new _Sitemaps_Posts(),
			'taxonomies' => new _Sitemaps_Taxonomies(),
			'users'      => new _Sitemaps_Users(),
		);

		/* @var _Sitemaps_Provider $provider */
	...
	public function render_sitemaps() {
		...
		if ( $stylesheet_type ) {
			$stylesheet = new _Sitemaps_Stylesheet();
	...
	/**
	 * Redirects a URL to the sitemap.xml
	 *
	 * @since 5.5.0
	 *
	 * @param bool     $bypass Pass-through of the pre_handle_404 filter value.
	 * @param _Query $query  The _Query object.
	...
	public function redirect_sitemapxml( $bypass, $query ) {
		...
		if ( 'sitemap-xml' === $query->get( 'pagename' )
			...
			_safe_redirect( $this->index->get_index_url() );
			exit();
		}
