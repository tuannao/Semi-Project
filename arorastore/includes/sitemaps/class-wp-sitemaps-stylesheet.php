<?php
/**
 * Sitemaps: _Sitemaps_Stylesheet class
 *
...
class _Sitemaps_Stylesheet {
	...
	public function render_stylesheet( $type ) {
		...
		if ( 'sitemap' === $type ) {
			// phpcs:ignore .Security.EscapeOutput.OutputNotEscaped -- All content escaped below.
	...
	public function get_sitemap_stylesheet() {
		...
		$description = esc_xml( __( 'This XML Sitemap is generated by  to make your content more visible for search engines.' ) );
		$learn_more  = sprintf(
			'<a href="%s">%s</a>',
...
XSL;
		 ...
		 */
		return apply_filters( '_sitemaps_stylesheet_content', $xsl_content );
	}
...
XSL;
		 ...
		 * @param string $xsl_content Full content for the XML stylesheet.
		 */
		return apply_filters( '_sitemaps_stylesheet_index_content', $xsl_content );
	}
		...
		$css = <<<EOF
					...
					#sitemap__table {
			 		...
			 		#sitemap__table tr td.loc {
						 ...
						 * See https://core.trac..org/ticket/16834
						 * and https://core.trac..org/ticket/49949
						 */
						direction: ltr;
					}
...
EOF;
		 ...
		 */
		return apply_filters( '_sitemaps_stylesheet_css', $css );
	}
}
