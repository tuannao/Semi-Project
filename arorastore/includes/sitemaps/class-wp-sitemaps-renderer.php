<?php
/**
 * Sitemaps: _Sitemaps_Renderer class
 *
...
class _Sitemaps_Renderer {
	...
	/**
	 * _Sitemaps_Renderer constructor.
	 *
	 * @since 5.5.0
	 */
	...
	public function get_sitemap_stylesheet_url() {
		 ...
		 */
		return apply_filters( '_sitemaps_stylesheet_url', $sitemap_url );
	}
	...
	public function get_sitemap_index_stylesheet_url() {
		 ...
		 */
		return apply_filters( '_sitemaps_stylesheet_index_url', $sitemap_url );
	}
	...
	public function render_index( $sitemaps ) {
		...
		if ( ! empty( $index_xml ) ) {
			...
			// phpcs:ignore .Security.EscapeOutput.OutputNotEscaped
			echo $index_xml;
		}
	}
