 ...
 */
function get_the_category_by_ID( $cat_id ) { // phpcs:ignore .NamingConventions.ValidFunctionName.FunctionNameInvalid
	$cat_id   = (int) $cat_id;
...
function wp_generate_tag_cloud( $tags, $args = '' ) {
	...
	if ( isset( $args['topic_count_text'] ) ) {
		...
		// phpcs:ignore .WP.I18n.NonSingularStringLiteralSingle,.WP.I18n.NonSingularStringLiteralPlural
...
function get_the_term_list( $post_id, $taxonomy, $before = '', $sep = '', $after = '' ) {
	 ...
	 */
	$term_links = apply_filters( "term_links-{$taxonomy}", $links );  // phpcs:ignore .NamingConventions.ValidHookName.UseUnderscores
 ...
 * @since 2.7.0 Can be used outside of the  Loop if `$post` is provided.
 *
