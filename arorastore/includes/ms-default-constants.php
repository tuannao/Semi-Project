...
function ms_upload_constants() {
	...
	// This is handled in _upload_dir() by ignoring UPLOADS for this case.
	if ( ! defined( 'UPLOADS' ) ) {
		...
		if ( 'content/blogs.dir' === UPLOADBLOGSDIR && ! defined( 'BLOGUPLOADDIR' ) ) {
			define( 'BLOGUPLOADDIR', _CONTENT_DIR . '/blogs.dir/' . $site_id . '/files/' );
		}
	}
}
...
function ms_file_constants() {
	 ...
	 * @since 3.0.0
	 */
	if ( ! defined( 'MU_SENDFILE' ) ) {
		define( 'MU_SENDFILE', false );
	}
	 ...
	 * @since 3.0.0
	 */
	if ( ! defined( 'MU_ACCEL_REDIRECT' ) ) {
		define( 'MU_ACCEL_REDIRECT', false );
	}
}
