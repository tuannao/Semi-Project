 ...
 * @see _Widget
 */
class _Widget_RSS extends _Widget {
	...
	public function widget( $args, $instance ) {
		...
		if ( $title ) {
			...
			$feed_link = sprintf(
				...
				esc_url( $feed_icon ),
				esc_attr__( 'RSS' ),
				( _lazy_loading_enabled( 'img', 'rss_widget_feed_icon' ) ? ' loading="lazy"' : '' )
			);
		...
		_widget_rss_output( $rss, $instance );
	...
	public function update( $new_instance, $old_instance ) {
		...
		return _widget_rss_process( $new_instance, $testurl );
	}
