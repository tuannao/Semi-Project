<?php
/**
 * Widget API: _Widget_Block class
 *
 * @package 
 * @subpackage Widgets
 * @since 5.8.0
 ...
 * @see _Widget
 */
class _Widget_Block extends _Widget {
	...
	public function widget( $args, $instance ) {
		$instance = _parse_args( $instance, $this->default_instance );
		 ...
		 * @param _Widget_Block $widget   Current Block widget instance.
		 */
		echo apply_filters(
