<?php
/**
 * Widget API: _Widget_Recent_Comments class
 *
 * @package 
 * @subpackage Widgets
 * @since 4.4.0
 ...
 * @see _Widget
 */
class _Widget_Recent_Comments extends _Widget {
	...
	public function __construct() {
		...
		if ( is_active_widget( false, false, $this->id_base ) || is_customize_preview() ) {
			add_action( '_head', array( $this, 'recent_comments_style' ) );
		}
	}
	...
	public function widget( $args, $instance ) {
		...
		$comments = get_comments(
			 ...
			 *
			 * @see _Comment_Query::query() for information on accepted arguments.
			 *
		...
		if ( is_array( $comments ) && $comments ) {
			...
			$post_ids = array_unique( _list_pluck( $comments, 'comment_post_ID' ) );
