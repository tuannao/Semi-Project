 ...
 * @see _Widget
 */
class _Widget_Text extends _Widget {
	...
	public function _register_one( $number = -1 ) {
		...
		_add_inline_script( 'text-widgets', sprintf( '.textWidgets.idBases.push( %s );', _json_encode( $this->id_base ) ) );
		...
		add_action( 'admin_footer-widgets.php', array( '_Widget_Text', 'render_control_template_scripts' ) );
	}
	...
	public function widget( $args, $instance ) {
		 ...
		 * and it applies after autop() to prevent corrupting HTML output added by the shortcode. When do_shortcode() is
		 ...
		 * @since 4.8.1 The `$widget` param may now be a `_Widget_Custom_HTML` object in addition to a `_Widget_Text` object.
		 *
		 * @param string                               $text     The widget content.
		 * @param array                                $instance Array of settings for the current widget.
		 * @param _Widget_Text|_Widget_Custom_HTML $widget   Current text or HTML widget instance.
		 */
		...
		if ( $is_visual_text_widget ) {
			 ...
			 *
			 * By default a subset of the_content filters are applied, including autop and texturize.
			 *
			 * @since 4.8.0
			 *
			 * @param string         $text     The widget content.
			 * @param array          $instance Array of settings for the current widget.
			 * @param _Widget_Text $widget   Current Text widget instance.
			 */
			 ...
			 * in core by adding do_shortcode() to the 'widget_text_content' filter to apply after autop().
			 * Since the legacy Text widget runs autop() after 'widget_text' filters are applied, the widget in
	 ...
	 * @since 4.9.0
	 *
	 * @see _Widget_Media_Video::inject_video_max_width_style()
	 *
	...
	public function update( $new_instance, $old_instance ) {
		...
		if ( current_user_can( 'unfiltered_html' ) ) {
			...
			$instance['text'] = _kses_post( $new_instance['text'] );
		}
	...
	public function enqueue_preview_scripts() {
		...
		_playlist_scripts( 'audio' );
		_playlist_scripts( 'video' );
	}
	...
	public function enqueue_admin_scripts() {
		_enqueue_editor();
		_enqueue_media();
		_enqueue_script( 'text-widgets' );
		_add_inline_script( 'text-widgets', '.textWidgets.init();', 'after' );
	}
	 ...
	 *
	 * @see _Widget_Text::render_control_template_scripts()
	 * @see __Editors::editor()
	 *
	...
	public static function render_control_template_scripts() {
		$dismissed_pointers = explode( ',', (string) get_user_meta( get_current_user_id(), 'dismissed__pointers', true ) );
		?>
		<script type="text/html" id="tmpl-widget-text-control-fields">
			...
			<?php if ( ! in_array( 'text_widget_custom_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="pointer custom-html-widget-pointer pointer-top">
			...
			<?php if ( ! in_array( 'text_widget_paste_html', $dismissed_pointers, true ) ) : ?>
				<div hidden class="pointer paste-html-pointer pointer-top">
					<div class="pointer-content">
			...
			<p>
				...
				<textarea id="{{ elementIdPrefix }}text" class="widefat text editor-area" style="height: 200px" rows="16" cols="20"></textarea>
			</p>
		</script>
		<?php
	}
