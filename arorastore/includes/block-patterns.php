...
/**
 * Register Core's official patterns from .org/patterns.
 *
 * @since 5.8.0
...
/**
 * Register `Featured` (category) patterns from .org/patterns.
 *
 * @since 5.9.0
 */
		...
		if ( file_exists( $dirpath ) ) {
			...
			if ( $files ) {
				foreach ( $files as $file ) {
					...
					//phpcs:ignore .WP.I18n.NonSingularStringLiteralText, .WP.I18n.NonSingularStringLiteralContext, .WP.I18n.NonSingularStringLiteralDomain, .WP.I18n.LowLevelTranslationFunction
