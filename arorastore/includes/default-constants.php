...
function wp_cookie_constants() {
	...
	if ( ! defined( 'PASS_COOKIE' ) ) {
		define( 'PASS_COOKIE', 'pass_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'AUTH_COOKIE' ) ) {
		define( 'AUTH_COOKIE', '_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'SECURE_AUTH_COOKIE' ) ) {
		define( 'SECURE_AUTH_COOKIE', '_sec_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'LOGGED_IN_COOKIE' ) ) {
		define( 'LOGGED_IN_COOKIE', '_logged_in_' . COOKIEHASH );
	}
	...
	if ( ! defined( 'TEST_COOKIE' ) ) {
		define( 'TEST_COOKIE', '_test_cookie' );
	}
	...
	if ( ! defined( 'RECOVERY_MODE_COOKIE' ) ) {
		 ...
		 * @since 5.2.0
		 */
		define( 'RECOVERY_MODE_COOKIE', '_rec_' . COOKIEHASH );
	}
}

/**
 * Defines SSL-related  constants.
 *
 * @since 3.0.0
 */
