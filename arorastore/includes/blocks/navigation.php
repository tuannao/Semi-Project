...
if ( defined( 'IS_GUTENBERG_PLUGIN' ) && IS_GUTENBERG_PLUGIN ) {
	/**
	 * Returns the menu items for a  menu location.
	 *
...
function block_core_navigation_get_first_non_empty_navigation() {
	...
	// see:
	// - https://github.com//-develop/blob/ba943e113d3b31b121f77a2d30aebe14b047c69d/src/wp-includes/nav-menu.php#L613-L619.
	// - https://developer..org/reference/classes/wp_query/#order-orderby-parameters.
	$parsed_args = array(
 ...
 * See https://developer..org/reference/functions/wp_nav_menu/#more-information.
 *
